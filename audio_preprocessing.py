...
DETECTION_DATASET_PATH = os.path.join(BASE_DIR, "detection_dataset")
DETECTION_JSON_PATH = "detection_data.json"
DETECTION_CSV_PATH = "detection_data.csv"
CLASSIFICATION_DATASET_PATH = os.path.join(BASE_DIR, "yt_dataset")
CLASSIFICATION_JSON_PATH = "classification_data.json"
CLASSIFICATION_CSV_PATH = "classification_data.csv"
SAMPLE_RATE = 22050


def save_features_in_JSON(dataset_path, json_path, num_mfcc=13, n_fft=2048, hop_length=512, num_segments=5):
...
def save_features_in_CSV(dataset_path, csv_path, num_mfcc=13, n_fft=2048, hop_length=512, num_segments=5):
...
if __name__ == "__main__":
    ...
    # save_features_in_JSON(DETECTION_DATASET_PATH, DETECTION_JSON_PATH, num_segments=1)
    # log_file.close()
    log_file = open(os.path.join(BASE_DIR, "detection_log.txt"), 'w')
    save_features_in_CSV(DETECTION_DATASET_PATH, DETECTION_CSV_PATH, num_segments=1)
    log_file.close()
    print("Detection dataset created successuflly.")

    print("Creating classification dataset.")
    mapping_file.write("\Classification:")
    # log_file = open(os.path.join(BASE_DIR, "classification_log.txt"), 'w')
    # save_features_in_JSON(CLASSIFICATION_DATASET_PATH, CLASSIFICATION_JSON_PATH, num_segments=1)
    # log_file.close()
    log_file = open(os.path.join(BASE_DIR, "classification_log.txt"), 'w')
    save_features_in_CSV(CLASSIFICATION_DATASET_PATH, CLASSIFICATION_CSV_PATH, num_segments=1)
    log_file.close()
